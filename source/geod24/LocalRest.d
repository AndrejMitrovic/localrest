...
class BaseFiberScheduler : C.Scheduler
{
     ...
     */
    override C.Condition newCondition(C.Mutex m) nothrow
    {
...
private:
    static class InfoFiber : Fiber
    {
        ...
        this(void delegate() op) nothrow
        {
            ...
            auto page_size = cast(size_t)sysconf(_SC_PAGESIZE);
            const stack_size = 16 * 1024 * 1024;  // match vibe.d for consistency
            super(op, stack_size);
        }
    }
...
private final class LocalScheduler : BaseFiberScheduler
{
    ...
    public override C.Condition newCondition(C.Mutex m = null) nothrow
    {
        assert(0);
    }
    ...
    private class FiberCondition : C.Condition
    {
        this() nothrow
        {
            super(null);
